...
const SkillsSection = () => (
  <SectionWrapper id="skills">
    <SectionHeading
      ...
      subtitle="Technologies I wield with mastery"
    />
    <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
      {Object.entries(skills).map(([category, items], catIdx) => (
        ...
        >
          <h3 className="font-cinzel text-lg font-semibold text-gradient-accent mb-5">
            {category}
          </h3>
            ...
            {items.map((skill) => (
              ...
              >
                ...
                <img
                  ...
                  src={skill.icon}
                  alt="node-js"
                  className="text-xl mx-auto block mb-1 group-hover:scale-110 transition-transform"
                />
